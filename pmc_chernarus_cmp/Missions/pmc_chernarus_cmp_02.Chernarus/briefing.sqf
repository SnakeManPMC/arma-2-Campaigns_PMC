...
player createDiaryRecord ["Diary", ["Command and Signal", "Your squad is 6 man MFR team, callsign Alpha."]];
player createDiaryRecord ["Diary", ["Support", "You have no support available."]];
player createDiaryRecord ["Diary", ["Execution", "Choose safe LZ, as close as possible to the airfield, but still safe enough that Marine's wont get killed by enemy fire on the insertion.<br/><br/>When you have chosen, use radio 0-0-1 to mark the spot (you can mark as many times you want, if you change your mind) where YOU ARE LOCATED, which will become the designated LZ. Make sure there is no obstructing buildings or foliage and enemy T72/ZSU's waiting nearby, use your brains Marine."]];
