...
_EG = "RU_Soldier_GL";
_EMG = "RU_Soldier_MG";
_EMed = "RU_Soldier_Medic";
_ECre = "RU_Soldier_Crew";
_ESni = "RU_Soldier_Sniper";
_ESpe = "RUS_Soldier1";
...
/*
if (typeOf _rusv1 == "UralCivil") then
{
	_q = 0;
	_n = 12;
	while {_q<_n} do
	{
		"RU_Soldier" CreateUnit [getPosASL east_start, _EASTtempgrparmor, "e3", 0.3, "Private"];
		_q = _q + 1;
...
if (typeOf _rusv1 == "UralCivil") then
{
	...
	while {_q<_n} do
	{
		"RU_Soldier" CreateUnit [getPosASL east_start, _EASTtempgrpair, "e3", 0.3, "Private"];
		_q = _q + 1;
		e3 moveInCargo _rusv1;
	};
};
