...
_WB = "USMC_Soldier";
_WAT = "USMC_Soldier_AT";
_WLAW = "USMC_Soldier_AT";
_WAA = "USMC_Soldier_AA";
_WOff = "USMC_Soldier_SL";
_WG = "USMC_Soldier_GL";
_WMG = "USMC_Soldier_MG";
_WMed = "USMC_Soldier_Medic";
_WCre = "USMC_Soldier_Crew";
_WSni = "USMC_SoldierS_Sniper";
_WSpe = "FR_TL";
