...
// add extra ammobox
RockBox2 = createVehicle ["USBasicAmmunitionBox", [(_tmp select 0), (_tmp select 1) + 10, 0], [], 0, "NONE"];
...
{
	_myGuy = "GUE_Soldier_1" createUnit [getPosASL player, group player, "removeAllweapons this", 0, "private"];
	_q = _q + 1;
