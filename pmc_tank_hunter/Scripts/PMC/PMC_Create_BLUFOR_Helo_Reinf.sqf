...
"USMC_Soldier_Pilot" createUnit [getPosASL west_helostart, _heloGrp, "", 1, "SERGEANT"];
"USMC_Soldier_Pilot" createUnit [getPosASL west_helostart, _heloGrp, "", 1, "CORPORAL"];

_poo = ["MH60S", "UH60M_EP1", "CH_47F_EP1"];
...
_ran = random(1);
"USMC_Soldier" createUnit [getPosASL west_helostart, _grp1, "", _ran, "SERGEANT"];
_ran = random(1);
"USMC_Soldier_AT" createUnit [getPosASL west_helostart, _grp1, "", _ran, "CORPORAL"];
_ran = random(1);
"USMC_Soldier_AT" createUnit [getPosASL west_helostart, _grp1, "", _ran, "CORPORAL"];
...
_ran = random(1);
"USMC_Soldier" createUnit [getPosASL west_helostart, _grp2, "", _ran, "SERGEANT"];
_ran = random(1);
"USMC_Soldier_AA" createUnit [getPosASL west_helostart, _grp2, "", _ran, "CORPORAL"];
_ran = random(1);
"USMC_Soldier_AA" createUnit [getPosASL west_helostart, _grp2, "", _ran, "CORPORAL"];
...
_ran = random(1);
"USMC_Soldier" createUnit [getPosASL west_helostart, _grp3, "", _ran, "SERGEANT"];
_ran = random(1);
"USMC_Soldier_AT" createUnit [getPosASL west_helostart, _grp3, "", _ran, "CORPORAL"];
_ran = random(1);
"USMC_Soldier_AT" createUnit [getPosASL west_helostart, _grp3, "", _ran, "CORPORAL"];
...
_ran = random(1);
"USMC_Soldier" createUnit [getPosASL west_helostart, _grp4, "", _ran, "SERGEANT"];
_ran = random(1);
"USMC_Soldier_AA" createUnit [getPosASL west_helostart, _grp4, "", _ran, "CORPORAL"];
_ran = random(1);
"USMC_Soldier_AA" createUnit [getPosASL west_helostart, _grp4, "", _ran, "CORPORAL"];
