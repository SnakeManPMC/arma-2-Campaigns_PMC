...
// 4
		...
		[
			...
			[
				"ORDERS",
				"T26 Reinforcements. Find the civilians to be recruited in one of the red cities."
			]
		];
...
//		PMC_objective2 setSimpleTaskDestination (getMarkerPos "target1");
		...
		PMC_objective1 = player createSimpleTask ["Find civilians"];
		PMC_objective1 setSimpleTaskDescription ["Find civilians in <marker name='target1'>red city</marker>.", "Find civilians", "Find civilians"];
...
/*
<a name = "OBJ_1'></marker>Find civilians
