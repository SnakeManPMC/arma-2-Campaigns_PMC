...
{_x allowfleeing 0} foreach units rusinf1;
{_x allowfleeing 0} foreach units rusinf2;
{_x allowfleeing 0} foreach units rusinf3;
{_x allowfleeing 0} foreach units rusinf4;
