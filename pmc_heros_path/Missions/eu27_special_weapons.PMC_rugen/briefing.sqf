...
// 2
		...
		[
			...
			[
				"2. YOUR MISSION:",
				"Jump on the waiting helo at the <marker name='start'>start</marker> location near Rozenburg.  Head southwest from the <marker name='insert'>insertion LZ</marker> with your SEALs to find and eliminate the <marker name='target1'>SCUD</marker> site. Radio (0-0-1) for helo pickup.<br/><br/>Before the Reds do something stupid with it, find the SCUD and wreck it. Stay back a safe distance from the thing; the propellant alone will cause a mighty hot fire.<br/><br/>Your SEALs <marker name='start'>start</marker> near Rozenburg. You'll get a helo ride to the <marker name='insert'>insertion LZ</marker>. Proceed southwest and destroy all equipment and personnel at the <marker name='target1'>SCUD</marker> site. Once the SCUD(s) are ruined, move to the <marker name='extract'>extraction LZ</marker> and use the radio command (0-0-1) to call helicopter pickup.<br/><br/>Rules of Engagement: <b>Condition Yellow.</b> There are far more Reds than there are of you. Keep a low profile. Good luck, and good hunting.<br/><br/>"
			]
		];
