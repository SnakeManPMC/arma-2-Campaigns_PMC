...
//a101 = ""A10"" createvehicle getpos A10_start; a101 setpos [(getpos a101 select 0),(getpos a101 select 1),200]; a101 setvelocity [200,0,0]; ""USMC_Soldier_Pilot"" createunit [getpos A10_start, leader assault1, ""p1 = this"", 1, ""MAJOR""]; [p1] join grpnull; a10killer=group p1; leader a10killer moveindriver a101; leader a10killer setcombatmode ""red""; leader a10killer setspeedmode ""full""; leader a10killer setbehaviour ""combat""; leader a10killer move getpos leader rustanks1; A10InFlight=true;

private ["_vcl", "_grp"];

_vcl = createVehicle ["A10", (getPos A10_start), [], 0, "FLY"];

_grp = createGroup west;
waitUntil {!(isNull _grp)};

_grp createunit ["USMC_Soldier_Pilot", getpos A10_start, [], 1, "FORM"];
