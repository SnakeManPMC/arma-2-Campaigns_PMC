private ["_pos","_count1","_count2","_rand1","_pos1","_pos2","_pos3","_pos4","_pos5"];
...
if (random 10 <= 2.5) then
{
	...
	while {_count2 < _rand1} do
	{
		...
		drop["cl_basic","","Billboard",1,5 +random 4,_pos5,[0,0,0],1,0.185,0.15,0.5,[6+random 5,8 + random 15],[[0.015+random 0.0175 -random 0.0175, 0.015+random 0.0175 -random 0.0175, 0.015+random 0.0175 -random 0.0175 ,0.75],[0.075+random 0.0175 -random 0.0175, 0.0175+random 0.0175 -random 0.0175, 0.0175+random 0.0175 -random 0.0175,0]],[0,1],0,0,"","",""];
